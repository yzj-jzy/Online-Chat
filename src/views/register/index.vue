    ...
    <div class="container">
      <div class="main">
        ...
        <div class="loginbox">
            ...
            <br>
                <div class="pwdbox">
                    <span class="pwd_iconfont"> <img src="../../recoures/confirmPwd.png"> </span>
                    <input  class="pwd"  id="password" v-model="confirmPwd" type="password"  placeholder="confirm password...">
                </div>
             <br>
             <el-button class="registerBtn" @click="register()"> register </el-button>
             <router-link :to="{ path: '/' }" class="logBtn" > return to Login</router-link>
       </div>
   
          <!-- 右侧的注册盒子 -->
           <div class="publicity">
                <div class="title"> Welcome to register page</div>
          </div>
...
export default {
    ...
    methods: {
        register(){
            ...
            const auth = getAuth();
            createUserWithEmailAndPassword(auth, this.email,this.pwd) .then((userCredential) => {
